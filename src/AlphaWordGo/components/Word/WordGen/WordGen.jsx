    ...
    <div className="flex flex-col items-center w-full min-h-screen bg-gradient-to-r from-teal-400 via-green-400 to-teal-600 p-6">
      ...
      <div className="w-full h-full flex flex-row justify-center gap-12">
        <div className="flex flex-col items-center mb-6">
          ...
          >
            Generate Word
            <span className="absolute -bottom-4 -right-8 text-xs p-2 rounded-r-none rounded-l-full rounded-b-full rounded-t-full bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-500 text-white transition-all duration-300 ease-in-out transform hover:scale-105">
